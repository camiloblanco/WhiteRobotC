...
public:
    ...
    int whiteStateMachine(double &last_trade_investment,int &m_state, std::vector<double> &m_slope, int &m_point, double &max_portfolio_val,
    ...
    bool checkTrailingStopLoss(double &last_trade_investment, std::vector<double> &m_portfolio_value,int &m_point, int &m_state,
                                      std::vector<int> &m_trial_stop_loss, int &m_long_trial_stop_Loss, double &m_stop_trialLoss,
                                      int &m_short_trial_stop_Loss, double &max_portfolio_val, std::vector<double> &m_prices);
};
